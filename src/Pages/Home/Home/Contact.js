        ...
        <div className="hero my-20 w-full">
            <div className="hero-content grid gap-10 md:grid-cols-2 flex-col lg:flex-row">
                ...
                <div className="card flex-shrink-0 w-full  shadow-2xl bg-base-100 ">
                    <h1 className="text-5xl font-bold text-center pt-5 text-yellow-600">Contact Me</h1>
                    <form  action='https://formspree.io/f/xgebwdrl' method='POST' className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" placeholder="First Name" name="First Name" className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Last Name</span>
                            </label>
                            <input type="text" placeholder="Last Name" name="Last Name" className="input input-bordered" />
                        </div>
                        </div>
                        <div className="form-control">
                            <label className="label">
